...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An AI consulting workspace for designing automation solutions end-to-end." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "AI Automation Architect" },
      { property: "og:description", content: "Design automation solutions like a senior AI consultant." },
